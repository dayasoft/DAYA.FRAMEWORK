public class DayaPolicyNames
{
    public const string Ab2CAuthenticateOnly = nameof(Ab2CAuthenticateOnly);
    public const string EntraExternalIdOnly = nameof(EntraExternalIdOnly);
